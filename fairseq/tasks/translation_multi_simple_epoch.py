...
class TranslationMultiSimpleEpochTask(LegacyFairseqTask):
    ...
    def __init__(self, args, langs, dicts, training):
        ...
        if getattr(args, "moe_expert_count", None):
            subset_num = args.moe_expert_count//4
        else:
            subset_num = 8
        self.top_k_cnt = {'easyvalid': subset_num, 'midvalid': subset_num, 'hardvalid': subset_num}
    ...
    def build_model(self, args):
        ...
        # if not top_k_status:
        #     subset_num = self.args.moe_expert_count//4
        #     self.top_k_status = {'easyvalid': subset_num, 'midvalid': subset_num, 'hardvalid': subset_num}
    ...
    def create_batch_sampler_func(
        ...
        def construct_batch_sampler(dataset, epoch):
            ...
            logger.debug(f"start batch sampler: mem usage: {data_utils.get_mem_usage()}")
            ...
            logger.debug(f"mem usage: {data_utils.get_mem_usage()}")
